...
// ----- Arduboy pins, modified for use on the Mega 2560-----

#define PIN_CS 12       // Display CS Arduino pin number
#define CS_PORT PORTB   // Display CS port
#define CS_BIT PORTB6   // Display CS physical bit number

#define PIN_DC 4        // Display D/C Arduino pin number
#define DC_PORT PORTG   // Display D/C port
#define DC_BIT PORTG5   // Display D/C physical bit number

#define PIN_RST 6       // Display reset Arduino pin number
#define RST_PORT PORTH  // Display reset port
#define RST_BIT PORTH3  // Display reset physical bit number

//I updated the ports for the LEDs here, however I did not change the code for
//them in Arduboy2Core.cpp, but commented it out.
...
#define RED_LED_BIT PORTB4

#define GREEN_LED_PORT PORTB
#define GREEN_LED_BIT PORTB5

#define BLUE_LED_PORT PORTH
#define BLUE_LED_BIT PORTH6

// bit values for button states
// these are determined by the buttonsState() function
#define LEFT_BUTTON _BV(2)  /**< The Left button value for functions requiring a bitmask */
#define RIGHT_BUTTON _BV(1) /**< The Right button value for functions requiring a bitmask */
#define UP_BUTTON _BV(0)    /**< The Up button value for functions requiring a bitmask */
...
//Bit values for Player 2 button states
#define LEFT_BUTTON_2 _BV(6)  /**< The Left 2 button value for functions requiring a bitmask */
#define RIGHT_BUTTON_2 _BV(7) /**< The Right 2 button value for functions requiring a bitmask */
#define UP_BUTTON_2 _BV(8)    /**< The Up 2 button value for functions requiring a bitmask */
#define DOWN_BUTTON_2 _BV(9)  /**< The Down 2 button value for functions requiring a bitmask */
#define A_BUTTON_2 _BV(10)     /**< The A 2 button value for functions requiring a bitmask */
#define B_BUTTON_2 _BV(11)     /**< The B 2 button value for functions requiring a bitmask */

#define PIN_LEFT_BUTTON A2
#define LEFT_BUTTON_PORT PORTF
#define LEFT_BUTTON_PORTIN PINF
#define LEFT_BUTTON_DDR DDRF
#define LEFT_BUTTON_BIT PORTF2

#define PIN_RIGHT_BUTTON A1
#define RIGHT_BUTTON_PORT PORTF
#define RIGHT_BUTTON_PORTIN PINF
#define RIGHT_BUTTON_DDR DDRF
#define RIGHT_BUTTON_BIT PORTF1

#define PIN_UP_BUTTON A0
#define UP_BUTTON_PORT PORTF
#define UP_BUTTON_PORTIN PINF
#define UP_BUTTON_DDR DDRF
#define UP_BUTTON_BIT PORTF0

#define PIN_DOWN_BUTTON A3
#define DOWN_BUTTON_PORT PORTF
#define DOWN_BUTTON_PORTIN PINF
#define DOWN_BUTTON_DDR DDRF
#define DOWN_BUTTON_BIT PORTF3

#define PIN_A_BUTTON 7
#define A_BUTTON_PORT PORTH
#define A_BUTTON_PORTIN PINH
#define A_BUTTON_DDR DDRH
#define A_BUTTON_BIT PORTH4

#define PIN_B_BUTTON 8
#define B_BUTTON_PORT PORTH
#define B_BUTTON_PORTIN PINH
#define B_BUTTON_DDR DDRH
#define B_BUTTON_BIT PORTH5

//Extra buttons for optional Player 2 They will be pins 22-27 in Port A
#define PIN_LEFT_BUTTON_2 22
#define LEFT_BUTTON_2_PORT PORTA
#define LEFT_BUTTON_2_PORTIN PINA
#define LEFT_BUTTON_2_DDR DDRA
#define LEFT_BUTTON_2_BIT PORTA0

#define PIN_RIGHT_BUTTON_2 23
#define RIGHT_BUTTON_2_PORT PORTA
#define RIGHT_BUTTON_2_PORTIN PINA
#define RIGHT_BUTTON_2_DDR DDRA
#define RIGHT_BUTTON_2_BIT PORTA1

#define PIN_UP_BUTTON_2 24
#define UP_BUTTON_2_PORT PORTA
#define UP_BUTTON_2_PORTIN PINA
#define UP_BUTTON_2_DDR DDRA
#define UP_BUTTON_2_BIT PORTA2

#define PIN_DOWN_BUTTON_2 25
#define DOWN_BUTTON_2_PORT PORTA
#define DOWN_BUTTON_2_PORTIN PINA
#define DOWN_BUTTON_2_DDR DDRA
#define DOWN_BUTTON_2_BIT PORTA3

#define PIN_A_BUTTON_2 26
#define A_BUTTON_2_PORT PORTA
#define A_BUTTON_2_PORTIN PINA
#define A_BUTTON_2_DDR DDRA
#define A_BUTTON_2_BIT PORTA4

#define PIN_B_BUTTON_2 27
#define B_BUTTON_2_PORT PORTA
#define B_BUTTON_2_PORTIN PINA
#define B_BUTTON_2_DDR DDRA
#define B_BUTTON_2_BIT PORTA5

#define PIN_SPEAKER_1 5  /**< The pin number of the first lead of the speaker */

//Only one speaker pin is defined.  The other pin will be connected to ground
#define SPEAKER_1_PORT PORTE
#define SPEAKER_1_DDR DDRE
#define SPEAKER_1_BIT PORTE3
...
#define RAND_SEED_IN_BIT PORTF4
